 ...
 *       &lt;sequence&gt;
 *         &lt;element name="proveedores" type="{http://www.tailoy.com.pe/ws/objects}proveedorows" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetProveedoresResponse {
    ...
    protected List<Proveedorows> proveedores;
     ...
     * 
     */
    public List<Proveedorows> getProveedores() {
        if (proveedores == null) {
            proveedores = new ArrayList<Proveedorows>();
        }
